...
function EncodingParamURL() {
    ...
    return (
        <div>
            <h3>Encoing Parameters In URLs</h3>
            ...
            <button onClick={() => fetchSubtract(a,b)} className="btn btn-primary mb-2 w-100">
...
export default EncodingParamURL