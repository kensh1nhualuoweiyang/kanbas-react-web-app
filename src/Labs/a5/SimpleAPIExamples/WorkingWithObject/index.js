...
function WorkingWithObject() {
    ...
    const URL = "https://kanbas-node-server-app-chen-f1c054a4dcda.herokuapp.com/a5/assignment"
    ...
    return (
        <div>
            ...
            <div className="form-check">
                <input type="checkbox" onChange={(e) => setAssignment({ ...assignment, completed: e.target.checked })} value="true" className="form-check-input" id="TrueLabel"
                    name="completed" />
                <label class="form-check-label" for="TrueLabel">
